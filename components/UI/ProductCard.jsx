...
const ProductCard = (props) => {
  ...
  return (
    <Link to={`/${props.item.id}/details`} className="product-card autoshow">
      <div className="card" id={props.item.id}>
        ...
        <div className="card-info">
          ...
          <p className="text-body">
            {truncateDescription(props.item.description, 10)}
          </p>
        </div>
        <div className="card-footer">
          ...
          <div className="card-button" onClick={props.addcart}>
