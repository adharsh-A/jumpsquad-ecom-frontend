...
if(process.env.NODE_ENV === "production"){
    ...
    try {
      ...
      if (!isLogin) {
        ...
        response = await axios.post(`${domainName}/api/auth/signup`, formData, {
          headers: {
            "Content-Type": "multipart/form-data",
          },
        });
      } else {
        response = await axios.post(`${domainName}/api/auth/login`, formData, {
          headers: {
            "Content-Type": "multipart/form-data",
          },
        });
        ...
        <div className="form-container">
          ...
          >
            <div className="input-group">
              <label
                htmlFor="username"
                className={errors.username ? "tooltip" : ""}
              >
                Username
                {errors.username && (
                  <span
